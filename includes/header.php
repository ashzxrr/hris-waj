...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&family=Inter:wght@600;700&display=swap"
        rel="stylesheet">
    <link
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?page=users">Karyawan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?page=attends">Absensi</a>
                    </li>
                    <li class="nav-item">
